...
public class TopPanel extends DraggablePictureLabelPanel {
	...
	private transient SerializablePicture picture;
			...
			public void drop(DropTargetDropEvent dtde) {
				try {
					...
					if (tr.isDataFlavorSupported(GUI.topPanel)) {
						...
						picture = (SerializablePicture) tr.getTransferData(GUI.sedgewickPicture);
						addPicture( picture);
						dtde.dropComplete(true);
					}
				} catch (Exception e) {
	...
	public void addPicture(final File file) {
		...
		addPicture(new SerializablePicture(file));
	}

	public void addPicture(final SerializablePicture picture) {
