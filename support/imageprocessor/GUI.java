...
public class GUI extends JFrame {
	...
	public static final DataFlavor sedgewickPicture = new DataFlavor(
			SerializablePicture.class, "Sedgewick Picture");
	...
	public static MenuTransform genMenuTransform(final String s,
		...
		return new MenuTransform() {
			...
			@Override
			public void transform(SerializablePicture source1, SerializablePicture source2,
					SerializablePicture target) {
		...
		go.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (source1.getPicture() != null) {
					...
					target.setPicture(new SerializablePicture(width, height));
				} else
					target.setPicture(new SerializablePicture(800, 600));
		...
		new DropTarget(save, DnDConstants.ACTION_COPY, new DropTargetAdapter() {
			public void drop(DropTargetDropEvent dtde) {
				try {
					...
					SerializablePicture picture = (SerializablePicture) tr
