...
public class WorkingPanel extends DraggablePictureLabelPanel {
	...
	public transient SerializablePicture picture;
	...
	public SerializablePicture getPicture() {
		return picture;
	}

	public void setPicture(SerializablePicture pic) {
		this.picture = pic;
	...
	public void clearpicture() {
		...
		this.removeAll();
		this.setVisible(true);
		//setPicture(new SerializablePicture(100,100));
	}
		...
		return new DropTargetAdapter() {
			public void drop(DropTargetDropEvent dtde) {
				try {
					...
					SerializablePicture picture = (SerializablePicture) tr.getTransferData(GUI.sedgewickPicture);
					setPicture(picture);
