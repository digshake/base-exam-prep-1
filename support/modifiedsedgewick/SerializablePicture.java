package support.modifiedsedgewick;
/*************************************************************************
 ...
 */
public final class SerializablePicture implements ActionListener, Serializable {
    /**
	 * 
	 */
   ...
   /**
     ...
     */
    public SerializablePicture(int w, int h) {
        width = w;
        height = h;
   ...
   /**
     ...
     */
    public SerializablePicture(String filename) {
   ...
   /**
     ...
     */
    public SerializablePicture(File file) {
        try {
   ...
   /**
    ...
    public JLabel getJLabel() {
        ...
        return new support.cse131.ResizeJLabel(icon);
    }
   ...
   /**
    ...
    public boolean equals(Object obj) {
        ...
        SerializablePicture that = (SerializablePicture) obj;
   ...
   /**
    ...
    public static void main(String[] args) {
        SerializablePicture pic = new SerializablePicture(args[0]);
